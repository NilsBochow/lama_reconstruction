...
unzip data128x128.zip -d celeba-hq-dataset/

# Reindex
for i in `echo {00001..30000}`
do
    mv 'celeba-hq-dataset/data128x128/'$i'.jpg' 'celeba-hq-dataset/data128x128/'$[10#$i - 1]'.jpg'
done
...
mkdir celeba-hq-dataset/train_128/
mkdir celeba-hq-dataset/val_source_128/
mkdir celeba-hq-dataset/visual_test_source_128/

cat celeba-hq-dataset/train_shuffled.flist | xargs -I {} mv celeba-hq-dataset/data128x128/{} celeba-hq-dataset/train_128/
cat celeba-hq-dataset/val_shuffled.flist | xargs -I {} mv celeba-hq-dataset/data128x128/{} celeba-hq-dataset/val_source_128/
cat celeba-hq-dataset/visual_test_shuffled.flist | xargs -I {} mv celeba-hq-dataset/data128x128/{} celeba-hq-dataset/visual_test_source_128/
